# Generated by Powerlevel10k configuration wizard on 2025-05-30 at 12:53 EDT.
...
# 24h time, angled separators, slanted heads, sharp tails, 2 lines, dotted, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # Version managers - using mise for all, removed: asdf, pyenv, goenv, nodenv, nvm, nodeenv, rbenv, rvm, jenv, etc.
